...
RESULT_DIR="$SCRIPT_DIR/resume_16g_ro_${TIMESTAMP}"
mkdir -p "$RESULT_DIR"
...
# A: lru, dram_ssd, dram_ssd_unconstrained (two_level+page_only done)
# D: all 5, E: all 5, F: all 5
REMAINING=(
   "a lru"
   "a dram_ssd"
...
echo ""
echo "============================================================"
echo "  RESUME 16G ReadOnly COMPLETE  $(date '+%Y-%m-%d %H:%M:%S')"
echo "============================================================"
