...
# =============================================================================
# Exp7 Group 2: Workloads A, E, F (no TPC-C)
#
# DAX = dax0.7,  SSD = exp7_comparison_ssd_g2  (独立 SSD 文件)
#
# YCSB:  A/E/F × 5 modes × 3 thetas = 45
# Total:                                45
# =============================================================================
...
SSD_PATH="/path/to/data/cxl_test_tmp/exp7_comparison_ssd_g2"
CXL_DAX_DEVICE="/dev/dax0.7"
...
TOTAL_EXPERIMENTS=$(( ${#YCSB_WORKLOADS[@]} * ${#MODES[@]} * ${#THETAS[@]} ))
...
# -----------------------------------------------------------------------------
main() {
   log_phase "Exp7 Group2: A/E/F (DAX=${CXL_DAX_DEVICE})"
   ...
   log_phase "EXP7 GROUP2 (A/E/F) COMPLETE"
