...
// ycsb_a_test.cpp
//
// YCSB-A (50% read, 50% update) workload simulation for CXL record cache experiments.
//
...
// ============================================================================
// Lookup phase — YCSB-A: 50% read, 50% update with ScrambledZipf key distribution
// ============================================================================
...
int main(int argc, char** argv)
{
   gflags::SetUsageMessage(
       "YCSB-A (50% read, 50% update) simulation for CXL record cache experiments");
   ...
   std::cout << "\n" << Color::BOLD << Color::CYAN
             << "============================================\n"
             << "  YCSB-A Test (50% Read, 50% Update, ScrambledZipf)\n"
             << "============================================"
             << Color::RESET << "\n";
   ...
   crm.scheduleJobSync(0, [&]() {
      table = LeanStoreAdapter<YCSBTable>(db, "YCSB_A_TEST");
   });
   ...
   print_phase("Phase 3: Measured Lookup (YCSB-A, 50% Read, 50% Update)");
   ...
   print_pass("YCSB-A test finished.");
   return 0;
}