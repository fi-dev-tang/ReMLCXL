...
void BufferManager::promoteRecordCacheEntry(u64 page_id, u16 slot_id, BufferFrame* cxl_bf){
   ...
   jumpmuTry(){
      ...
      // [F6] Large-Record guard: when a single record approaches page-level
      // footprint (>= PAGE_SIZE/8 = 2KB), route to full-page promotion instead
      // of wasting a slab on a handful of blocks.
