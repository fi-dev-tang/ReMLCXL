...
// -------------------------------------------------------------------------------------
// =====================================================================================
// [Caution].Added explaniation
// The original author combine two seperate function into one structure
// 1. Memory Usage: dram_free_list and cxl_free_list
// 2. PID allocation
// [Here PID allocation is called through nextPID() and allocatePages()]
// In our usage, when calling allocatePage, it is always prepare to write a new page for data loadding
// or leaf separation, it is create at once and write at once.
// We leave the allocatePage() and nextPID() function only in DRAM-Tier
// actually, this Partition is only useful for CXL-tiering with the only parameter: cxl_free_list.
//
//======================================================================================
struct Partition {
   std::mutex ht_mutex;
